...
public class Encodes {
    ...
    public static String encodeBase62(byte[] input) {
        ...
        for (int i = 0; i < input.length; i++) {
            chars[i] = Constants.CharInfo.BASE62[((input[i] & 0xFF) % Constants.CharInfo.BASE62.length)];
        }
    ...
    public static String encodeUrl(String url) {
        return encodeUrl(url, Constants.CharInfo.UTF_8);
    }
    ...
    public static String decodeUrl(String part) {
        return decodeUrl(part, Constants.CharInfo.UTF_8);
    }
