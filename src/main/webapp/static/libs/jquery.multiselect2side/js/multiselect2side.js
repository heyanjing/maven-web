            ...
            return this.each(function () {
                ...
                var htmlToAdd =
                    ...
                    ((o.selectedPosition == 'right')
                            ...
                            :
                            ("<p class='AddOne' title='閫夋嫨'><i class='icon-chevron-left'></i></p>" +
                            "<p class='AddAll' title='鍏ㄩ€�'><i class='icon-backward'></i></p>" +
                            "<p class='RemoveOne' title='绉婚櫎'><i class='icon-chevron-right'></i></p>" +
                            "<p class='RemoveAll' title='娓呯┖'><i class='icon-forward'></i></p>")
                    ) +
                    "</div>" +
                    "<div class='ms2side__select'>" +
